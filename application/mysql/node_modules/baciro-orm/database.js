...
/** Dokumentasi orm*/
  /** Read Operation **/
    ...
    */
    ...
    //mysql
    /*
    10. Fungsi findLastId(query,callback) digunakan untuk mengambil id terakhir atau id terbesar dari suatu tabel.

        Parameter input :
        - query : nama coloumn dari tabel yang menyimpan id

        Parameter output :
        - err, digunakan untuk menampung setiap error
        - data, digunakan untuk menampung hasil query berupa array JSON.

        contoh penggunaan Fungsi findLastId():
        user.findLastId("user_id",function(err,data){
          console.log();
      })
    */
  ...
  /** Delete Operation **/
    ...
    1. Fungsi delete(query, callback) digunakan untuk mengubah satu record tertentu berdasarkan kondisi tertentu.
       ...
       Parameter input:
       - query: Kondisi data yang akan dihapus, data berupa array json. contoh [{"firstname" : khoirul},{"lastname" : fikri}]
...
//tambahan untuk mendapatkan id terakhir
Orm.prototype.findLastId = function(query, callback){
	this.driver.findLastId(query, callback);
}
...
Orm.prototype.findGroupBy = function (query, callback){
  this.driver.findGroupBy(query, callback);
}
...
Orm.prototype.findJoinGroupBy = function(query, join, query1, callback){
  //load schema tabel join, get key join
  for(key in join){
    keyJoin = key;
  }
  ...
  this.driver.findJoinGroupBy(query, join, query1, schemaJoin, callback);
}
