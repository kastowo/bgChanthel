...
--
-- Host: localhost    Database: baciro
-- ------------------------------------------------------
...
INSERT INTO `Cluster` VALUES (2,'Yava02','default','2017-01-17 00:00:00','2017-02-16 09:30:42');
...
INSERT INTO `Config` VALUES (1,'2017-02-01 06:08:04','2017-02-17 17:17:56','usernameOozie','yava',2),(2,'2017-02-01 06:08:43','2017-02-13 16:04:04','nameNode','hdfs://192.168.1.230:8020',2),(3,'2017-02-01 06:09:05','2017-02-13 16:04:23','jobTracker','192.168.1.231:8050',2),(4,'2017-02-13 16:06:40',NULL,'oozieWfPath','${nameNode}/user/yava/baciro/workflow/faroh/workflow.xml',2),(5,'2017-02-13 16:07:00',NULL,'hostnameOozie','192.168.1.231',2),(6,'2017-02-13 16:07:26',NULL,'portOozie','11000',2),(7,'2017-02-13 16:08:42',NULL,'portHdfs','50070',2),(8,'2017-02-13 16:09:05','2017-02-17 18:04:19','usernameHdfs','yava',2),(9,'2017-02-13 16:09:19',NULL,'queueName','level1',2),(10,'2017-02-13 16:09:46',NULL,'hostnameHdfs','192.168.1.230',2),(11,'2017-02-17 17:58:47',NULL,'useSystemLibpath','true',2),(12,'2017-02-17 18:00:18',NULL,'oozieLibpath','${nameNode}/user/yava/oozie/hgrid/lib',2);
...
CREATE TABLE `Member` (
  ...
  `member_role` varchar(25) DEFAULT NULL,
...
-- Dump completed on 2017-02-23  5:40:30
